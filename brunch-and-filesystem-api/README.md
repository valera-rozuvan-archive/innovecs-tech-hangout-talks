Checkout [the demo](https://valera-rozuvan.github.io/Tech-Hangout/brunch-and-filesystem-api/). NOTE: for now (now is November 30, 2012) it only works in Google's [Chrome browser](http://www.google.com/chrome/).
